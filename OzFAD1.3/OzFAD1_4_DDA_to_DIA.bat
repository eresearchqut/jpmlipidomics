@ECHO OFF
rem ECHO ------- OzFAD1 stage 3 -------
rem ECHO This batch file controls the de novo fatty acid analysis workflow using LC-OzID-MS data.
rem ECHO This stage creates a Skyline file containing the confirmed transitions applied to the data independent acquisition for the purpose of relative quantification of isomers.
...
rem ECHO  4 The appropriate file skyl_report_dda_found.csv and OzFAD1_workflow_parameters.xlsx must be copied into OzFAD1.
rem ECHO ____
...
rem "C:\Users\menzel2\AppData\Local\Programs\Python\Python39\python.exe" "%~dp0\OzFAD1_black_box\OzFAD1_py\OzFAD1_py_black_box\jpmlipidomics_dda_to_dia_3_rt_shift1.py"
"python.exe" "%~dp0\OzFAD1_black_box\OzFAD1_py\OzFAD1_py_black_box\jpmlipidomics_dda_to_dia_3_rt_shift1.py"
...
rem "C:\Users\menzel2\AppData\Local\Programs\Python\Python39\python.exe" "%~dp0\OzFAD1_black_box\OzFAD1_py\OzFAD1_py_black_box\jpmlipidomics_dda_to_dia_4_rt_shift2.py"
"python.exe" "%~dp0\OzFAD1_black_box\OzFAD1_py\OzFAD1_py_black_box\jpmlipidomics_dda_to_dia_4_rt_shift2.py"
...
rem "C:\Users\menzel2\AppData\Local\Programs\Python\Python39\python.exe" "%~dp0\OzFAD1_black_box\OzFAD1_py\OzFAD1_py_black_box\jpmlipidomics_dda_to_dia_4_integrationcheck.py"
"python.exe" "%~dp0\OzFAD1_black_box\OzFAD1_py\OzFAD1_py_black_box\jpmlipidomics_dda_to_dia_4_integrationcheck.py"
...
move %~dp0\OzFAD1_3_DDA_confirmed_DIA_RT_adjusted.csv %~dp0\OzFAD1_results\%identifier%\transition_lists_and_report_csv_files_dda
